             ...
             //   }
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            sh "docker run  -t --rm -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' -w ${IMAGE} 'ls -la' "
                            sh "docker run  -t --rm -v  ${env.WORKSPACE}/${env.BUILD_ID}:/src -w  ${IMAGE} 'ls -la sources' "
                            sh "docker run  -t --rm -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' -w  ${IMAGE} ls -la src/sources "
                            sh "docker run  -t --rm -v  '${env.WORKSPACE}:/src' ${IMAGE} -w  'ls -la sources/' "
