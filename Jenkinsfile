              ...
              // }
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            sh "docker run --rm -v ${env.WORKSPACE}/${env.BUILD_ID}/sources  --entrypoint ls -la ${IMAGE} /src"
                            sh "docker run --rm -v  ${env.WORKSPACE}/${env.BUILD_ID}/sources  --entrypoint cat ${IMAGE} ${env.WORKSPACE}/${env.BUILD_ID}/sources/add2vals.py"
