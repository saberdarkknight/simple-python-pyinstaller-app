        ...
        stage('Deliver') {
                    ...
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            sh "docker run --rm -v ${env.WORKSPACE}/${env.BUILD_ID}/sources  --entrypoint ls ${IMAGE} /src"
                            sh "docker run --rm -v ${env.WORKSPACE}/${env.BUILD_ID}/sources  --entrypoint cat ${IMAGE} addvals.py"
