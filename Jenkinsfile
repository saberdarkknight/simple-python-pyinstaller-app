             ...
             //   }
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            sh "docker run  -v  '${env.WORKSPACE}/${env.BUILD_ID}/sources:/src' ${IMAGE} 'ls -la' "
                            sh "docker run  -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' ${IMAGE} 'ls -la' "
                            sh "docker run  -v  ${env.WORKSPACE}/${env.BUILD_ID}:/src ${IMAGE} 'ls -la sources' "
                            sh "docker run  -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' ${IMAGE} ls -la src/sources "
                            sh "docker run  -v  '${env.WORKSPACE}:/src' ${IMAGE} 'ls -la sources/' "
                            ...
                            //sh 'pyinstaller -F ${env.WORKSPACE}/sources/add2vals.py'
                        }
                    }
            post {
                success {
