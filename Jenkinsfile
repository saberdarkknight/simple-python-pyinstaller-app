             ...
             //   }
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            sh "docker run --rm -v  '${env.WORKSPACE}/${env.BUILD_ID}/sources:/src' ${IMAGE} 'ls -la' "
                            sh "docker run --rm -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' ${IMAGE} 'ls -la' "
                            sh "docker run --rm -v  ${env.WORKSPACE}/${env.BUILD_ID}:/src ${IMAGE} 'ls -la sources' "
                            sh "docker run --rm -v  '${env.WORKSPACE}/${env.BUILD_ID}:/src' ${IMAGE} ls -la src/sources "
                            sh "docker run --rm -v  '${env.WORKSPACE}:/src' ${IMAGE} 'ls -la sources/' "
